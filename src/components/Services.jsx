              ...
              <div className='py-12 px-4 xl:px-8'>
                ...
                <ul className='flex items-center justify-between'>
                  {brainwaveServicesIcons.map((item, index) => (
                    <li key={index} className='w-[3rem] h-[3rem] rounded-2xl flex items-center justify-center hover:w-[3rem] hover:h-[3rem] hover:p-0.25 hover:bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]  hover:md:w-[4.5rem] hover:md:h-[4.5rem]'>
